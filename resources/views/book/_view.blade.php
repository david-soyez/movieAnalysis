...
<br>
Sum 20% - higher is harder -> {{ round($book->getTotal20(),8) }}<br>
Mean(lines) 20% - higher is harder -> {{ round($book->getMean20(),8) }}<br>
Sum above 20% - higher is harder -> {{ round($book->getTotalAbove20(),8) }}<br>
Mean(lines) above 20% - higher is harder -> {{ round($book->getMeanAbove20(),8) }}<br>
<br><br>
